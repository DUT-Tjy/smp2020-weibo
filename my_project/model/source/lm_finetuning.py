    ...
    def __init__(self, tokenizer, file_path='train', block_size=512):
        ...
        if os.path.exists(cached_features_file):
            ...
            for text in texts:
                ...
                tokenized_text += [tokenizer.pad_token_id] * (block_size-len(tokenized_text)+2)
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    tb_writer.add_scalar('loss', (tr_loss - logging_loss) / args.save_steps, global_step)
                    logging_loss = tr_loss
                    globl_score = results['perplexity']

                    # Save model checkpoint
                    if globl_score < best_score:
                        ...
                        logger.info("Saving best model, perplexity:{}".format(results['perplexity']))
                        best_score = globl_score
